<script lang="ts">
  ...
  // Event handlers
  export let onInput: ((value: string | number) => void) | undefined = undefined;
  ...
  $: baseClasses = 'w-full px-3 py-2 text-sm border rounded-lg transition-colors focus:outline-none focus:ring-2';
