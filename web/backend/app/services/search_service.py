...
class SearchService:
    ...
    async def search_simple(
        ...
        cache_key = self._get_cache_key(
            ...
            min_score=min_score, article_id=article_id, search_type="simple"
        )
    ...
    async def search_hybrid(
        ...
        cache_key = self._get_cache_key(
            query=query, collection=collection, limit=limit,
            min_score=min_score, article_id=article_id, 
            fusion_method=fusion_method, search_type="hybrid"
        )
    ...
    async def get_article(self, collection: str, article_id: int) -> List[Dict[str, Any]]:
    ...
    def group_results_by_article(self, results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
